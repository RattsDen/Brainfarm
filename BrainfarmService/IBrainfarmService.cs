...
namespace BrainfarmService
{
    ...
    public interface IBrainfarmService
    {
        ...
        [OperationContract]
        [WebInvoke]
        Project EditProject(string sessionToken, int projectID, string title, string[] tags);
        ...
        [OperationContract]
        [WebInvoke]
        Bookmark BookmarkComment(string sessionToken, int commentID);

        [OperationContract]
        [WebInvoke]
        Bookmark UnbookmarkComment(string sessionToken, int commentID);
        ...
        [OperationContract]
        [WebInvoke]
        List<Comment> GetUserBookmarkedComments(string sessionToken);
